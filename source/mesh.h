...
// TODO Where this should go, I think as this is part of the projection pipeline, maybe in the application itself.
...
global_f void 
mesh_render(memory_t *engine_memory, mesh_t *_mesh)
{				
