 ...
 * \sa SDL_GetWindowTransform
 */
extern DECLSPEC void SDLCALL SDL_SetWindowTransform(SDL_Window * window,
                                                   int x, int y);
 ...
 * \sa SDL_SetWindowTransform
 */
extern DECLSPEC void SDLCALL SDL_GetWindowTransform(SDL_Window * window,
                                                   int *x, int *y);
